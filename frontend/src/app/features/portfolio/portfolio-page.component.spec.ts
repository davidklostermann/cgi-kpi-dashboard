...
describe('PortfolioPageComponent', () => {
  ...
  it('should keep loaded portfolio AI analysis when the drawer is closed and reopened', () => {
    const fixture = TestBed.createComponent(PortfolioPageComponent);
    fixture.detectChanges();
    ...
    const panel = fixture.debugElement.query(
      (element) => element.name === 'app-portfolio-ai-panel',
    )?.componentInstance as PortfolioAiPanelComponent;
    panel.load();
    fixture.detectChanges();
      ...
      insights: [
        {
          ...
          title: 'Trend sichtbar nach Reload',
          finding: 'Finding',
          ...
          affectedProjectNames: ['Nexus Analytics Pilot', 'Cloud Migration Wave 2'],
          evidence: [
            { label: 'A', value: '1', projectId: 'a0000000-0000-4000-8000-000000000001' },
            { label: 'B', value: '2', projectId: 'a0000000-0000-4000-8000-000000000002' },
          ],
          confidence: 'HIGH',
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toContain('Trend sichtbar nach Reload');
    ...
    expect(fixture.nativeElement.textContent).toContain('Trend sichtbar nach Reload');
    expect(fixture.nativeElement.textContent).not.toContain('Portfolio analysieren');
    httpMock.expectNone('/api/portfolio/ai/trend-analysis');
  });
