...
class PortfolioProjectFilterTest {
    ...
    @Test
    void deliveryMethodFilterMatchesExactEnumValues() {
        List<PortfolioKpiProjectInput> projects = List.of(
                project(PROJECT_A, "ON_TRACK", "Acme GmbH", "Anna Keller", "Umsetzung", "2026-07"),
                new PortfolioKpiProjectInput(
                        PROJECT_B,
                        "CRITICAL",
                        "Beta AG",
                        "Markus Brenner",
        ...
        List<PortfolioKpiProjectInput> filtered =
                filter.applyProjects(projects, criteria, filter.projectIdsMatchingRiskSeverity(List.of(), null));
