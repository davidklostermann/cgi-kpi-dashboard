...
public class DefaultProjectKpiService implements ProjectKpiService {
    ...
    private final AgileProjectDataProvider agileProjectDataProvider;

    public DefaultProjectKpiService(
            ProjectKpiReader projectKpiReader,
            AgileProjectDataProvider agileProjectDataProvider) {
        this.projectKpiReader = projectKpiReader;
        this.agileProjectDataProvider = agileProjectDataProvider;
    }
    ...
    @Override
    public ProjectIsoManagementDto getProjectIsoManagement(UUID projectId) {
        return require(projectKpiReader.readProjectIsoManagement(projectId));
    }

    @Override
    public AgileDeliveryDto getAgileDelivery(UUID projectId) {
        return require(agileProjectDataProvider.readAgileDelivery(projectId));
    }
