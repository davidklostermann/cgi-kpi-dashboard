...
public class ProjectController {
    ...
    @GetMapping("/{id}/issues-actions")
    public ProjectIssuesActionsDto getProjectIssuesActions(@PathVariable UUID id) {
        return projectKpiService.getProjectIssuesActions(id);
    }

    @GetMapping("/{id}/capacity")
    public ProjectCapacityDto getProjectCapacity(@PathVariable UUID id) {
        return projectKpiService.getProjectCapacity(id);
    }

    @GetMapping("/{id}/iso-management")
    public ProjectIsoManagementDto getProjectIsoManagement(@PathVariable UUID id) {
        return projectKpiService.getProjectIsoManagement(id);
    }

    @GetMapping("/{id}/agile-delivery")
    public AgileDeliveryDto getAgileDelivery(@PathVariable UUID id) {
        return projectKpiService.getAgileDelivery(id);
    }
}
