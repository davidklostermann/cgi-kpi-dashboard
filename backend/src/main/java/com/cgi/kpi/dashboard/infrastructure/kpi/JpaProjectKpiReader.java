...
import com.cgi.kpi.dashboard.infrastructure.persistence.ProjectIsoManagementRepository;
...
import com.cgi.kpi.dashboard.kpi.service.ProjectIsoManagementAssembler;
...
public class JpaProjectKpiReader implements ProjectKpiReader {
    ...
    private final ProjectIsoManagementRepository projectIsoManagementRepository;
    ...
    private final ProjectIsoManagementAssembler projectIsoManagementAssembler;
    ...
    public JpaProjectKpiReader(
            ...
            ProjectIsoManagementRepository projectIsoManagementRepository,
            ...
            ProjectIsoManagementAssembler projectIsoManagementAssembler,
        ...
        this.projectIsoManagementRepository = projectIsoManagementRepository;
        ...
        this.projectIsoManagementAssembler = projectIsoManagementAssembler;
    ...
    public Optional<ProjectMasterDataDto> readProjectMasterData(UUID projectId) {
        ...
        return Optional.of(new ProjectMasterDataDto(
                ...
                method.name(),
                AgileDeliveryCalculator.deliveryMethodLabel(method),
    ...
    @Override
    public Optional<ProjectIsoManagementDto> readProjectIsoManagement(UUID projectId) {
        Optional<Project> projectOpt = projectRepository.findByIdAndWorkspaceId(
                projectId, currentUserService.requireWorkspaceId());
        if (projectOpt.isEmpty()) {
            return Optional.empty();
        }
        Project project = projectOpt.get();
        Optional<ProjectIsoManagement> isoOpt = projectIsoManagementRepository.findById(projectId);
        if (isoOpt.isEmpty()) {
            return Optional.of(projectIsoManagementAssembler.assembleEmpty(project));
        }
        return Optional.of(projectIsoManagementAssembler.assemble(project, isoOpt.get()));
    }
