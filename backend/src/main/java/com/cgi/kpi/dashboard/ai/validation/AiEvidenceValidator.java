...
public class AiEvidenceValidator {
    ...
    public ProjectAiQuestionResponseDto validateQuestion(
        ...
        return validateQuestionAgainstAllowed(raw, allowed);
    }

    public ProjectAiQuestionResponseDto validatePortfolioQuestion(
    ...
    private ProjectAiQuestionResponseDto validateQuestionAgainstAllowed(
            ProjectAiQuestionResponseDto raw,
            Set<String> allowed) {
        List<String> evidence = filterEvidence(raw.evidenceFactIds(), allowed);
        if (raw.insufficientEvidence() && evidence.isEmpty()) {
            String answer = raw.answer();
